package com.gnrd.cart.security.controllers;
...
import com.gnrd.cart.security.dtos.LoginUser;
import com.gnrd.cart.security.dtos.NewUser;
...
import com.gnrd.cart.security.jwt.JwtProvider;
import com.gnrd.cart.security.services.RoleService;
import com.gnrd.cart.security.services.UserService;

import com.gnrd.cart.security.util.CookieUtil;
...
public class AuthController {
    ...
    public ResponseEntity<Object> login(HttpServletResponse httpServletResponse,
        ...
        try {
            ...
            CookieUtil.create(httpServletResponse, cookieName, jwt, false, -1, "cloud.google.com");
